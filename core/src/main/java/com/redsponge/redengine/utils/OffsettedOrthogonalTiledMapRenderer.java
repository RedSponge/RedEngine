...
public class OffsettedOrthogonalTiledMapRenderer extends OrthogonalTiledMapRenderer {
    ...
    public OffsettedOrthogonalTiledMapRenderer(TiledMap map) {
        super(map);
    }

    public OffsettedOrthogonalTiledMapRenderer(TiledMap map, Batch batch) {
        super(map, batch);
    }

    public OffsettedOrthogonalTiledMapRenderer(TiledMap map, float unitScale) {
        super(map, unitScale);
    }
