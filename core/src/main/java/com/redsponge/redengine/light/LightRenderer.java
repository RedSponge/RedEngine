...
public class LightRenderer implements Disposable, IAssetRequirer {
    ...
    public LightRenderer(int width, int height, SpriteBatch batch, Assets assets, FitViewport viewport) {
        this.batch = batch;
        this.assets = assets;
